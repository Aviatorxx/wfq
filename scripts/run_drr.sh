...
python src/sender.py --flow 1 --weight 1 --size 1024 --rate 1 --dur 10 --mode drr &
SENDER1_PID=$!

# Flow 2: 权重=1, 包大小=512
sleep 2
python src/sender.py --flow 2 --weight 1 --size 512 --rate 1 --dur 6 --mode drr &
SENDER2_PID=$!

# Flow 3: 权重=2, 包大小=1024
sleep 2
python src/sender.py --flow 3 --weight 2 --size 1024 --rate 1 --dur 6 --mode drr &
SENDER3_PID=$!
